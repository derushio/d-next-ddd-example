...
初めてClean ArchitectureやDIに触れる方向けに、わかりやすい解説を用意しました！

- **[DI入門ガイド](./_DOCS/guides/ddd/concepts/whats-di.md)** - 「DIって何？」から実践まで、解説
- **[レイヤー構成解説](./_DOCS/guides/ddd/layers/)** - Clean Architectureの4層構造を説明

**💡 ポイント**: DIは「部品の組み立てを自動化する仕組み」です。テストしやすく、変更に強いコードが書けるようになります。
