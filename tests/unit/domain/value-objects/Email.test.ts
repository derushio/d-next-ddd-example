...
describe('Email Value Object', () => {
  describe('constructor', () => {
    ...
    it.each([
      ...
      'user@sub.domain.com',
      'a@b.co',
    ])('各種有効なメールアドレス形式で作成できる: %s', (emailStr) => {
    ...
    it.each([
      ...
      '無効な形式のメールアドレスでDomainError（EMAIL_INVALID_FORMAT）が発生する: %s',
      (emailStr) => {
        expect(() => new Email(emailStr)).toThrow(DomainError);
    ...
    it('長すぎるメールアドレスでDomainError（EMAIL_TOO_LONG）が発生する', () => {
      ...
      expect(() => new Email(longEmail)).toThrow(DomainError);
    ...
    it.each([
      ...
      '禁止文字を含むメールアドレスでDomainError（EMAIL_INVALID_CHARACTERS）が発生する: %s',
      (emailStr) => {
        expect(() => new Email(emailStr)).toThrow(DomainError);
        expect(() => new Email(emailStr)).toThrow(
