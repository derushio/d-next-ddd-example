...
import { formatTime } from '@/utils/dfUtils';
    ...
    return (
      <div className='space-y-6'>
        ...
        <div className='flex items-center gap-3 pb-4 border-b border-violet-300'>
          ...
          <Badge variant='success'>Server Component</Badge>
          <Badge variant='blue'>{executionTime}ms</Badge>
        </div>
          ...
          >
            <Card.Header>
              <div className='flex items-center gap-2'>
                ...
                <Badge variant='warning'>Domain</Badge>
              </div>
            </Card.Header>
            <Card.Content>
              <div className='space-y-3'>
                <div className='bg-white/60 rounded-lg p-3 border border-orange-200/50'>
                  ...
                  <div className='flex items-center gap-2'>
                    ...
                    <Badge variant={domainResult ? 'warning' : 'success'}>
          ...
          >
            <Card.Header>
              <div className='flex items-center gap-2'>
                ...
                <Badge variant='success'>Infrastructure</Badge>
              </div>
            </Card.Header>
            <Card.Content>
              <div className='space-y-3'>
                <div className='bg-white/60 rounded-lg p-3 border border-green-200/50'>
                  ...
                  <div className='flex justify-between items-center'>
                    ...
                    <Badge variant='success'>Data Access Success</Badge>
                  </div>
                </div>
              </div>
            </Card.Content>
              ...
              <div className='space-y-3'>
                <div className='bg-white/60 rounded-lg p-3 border border-purple-200/50'>
                  ...
                  <div className='flex justify-between items-center mb-2'>
                    ...
                    <Badge variant='success'>4 services</Badge>
                  </div>
                  <div className='flex justify-between items-center'>
                    <span className='text-sm font-medium text-gray-700'>
                      Timestamp:
        ...
        <div className='pt-6 border-t border-violet-300'>
          <div className='bg-gradient-to-br from-violet-50 to-cyan-50 border border-violet-200 rounded-xl p-5 relative overflow-hidden'>
            ...
            <div className='flex items-start gap-4 mt-1'>
              <div className='size-10 bg-gradient-to-r from-violet-500 to-cyan-500 rounded-xl flex items-center justify-center shadow-lg hover:scale-110 transition-transform flex-shrink-0'>
              ...
              <div>
                ...
                <div className='flex flex-wrap gap-2'>
                  <Badge variant='blue'>Infrastructure Layer</Badge>
                  <Badge variant='warning'>Domain Layer</Badge>
                  <Badge variant='success'>TSyringe DI</Badge>
    ...
    return (
      <div className='space-y-4'>
        ...
        <Card variant='sunset' className='border-2 border-red-200'>
          <Card.Header>
            <h3 className='text-lg font-semibold text-red-800 text-balance'>
              実行エラーが発生しました
            </h3>
          </Card.Header>
          <Card.Content>
