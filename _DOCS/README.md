...
3. ⚡ [最初の機能実装](guides/development/first-feature.md) - 実装チュートリアル
```
...
graph LR
    subgraph "🏗️ 設計・アーキテクチャ"
        ...
        G3[📐 設計決定記録<br/>guides/project-architecture-decisions.md]
    end
...
修正実装: [開発フロー](guides/development/workflow.md) → [コーディング規約](guides/standards/coding.md)
         ↓
検証: [テスト実装](testing/unit/overview.md)
```
...
1週目: [テスト基礎](testing/unit/overview.md) → [開発フロー](guides/development/workflow.md)
...
| **UI実装**         | [フロントエンド](guides/frontend-best-practices.md)                          | [Server Actions](guides/ddd/layers/components/server-actions.md) + [テーマシステム](guides/theme-system.md)                              | [よくある問題](troubleshooting/common-issues.md)                       |
| **テスト追加**     | [ユニットテスト](testing/unit/overview.md)                                   | [モック戦略](testing/unit/mocking.md) + [テスト戦略](testing/strategy.md)                                                                | [vitest-mock設定](troubleshooting/development/vitest-mock-extended-setup.md) |
...
- **Linting**: Biome
- **UI**: TailwindCSS v4 + shadcn/ui + **統一スタイルシステム**
